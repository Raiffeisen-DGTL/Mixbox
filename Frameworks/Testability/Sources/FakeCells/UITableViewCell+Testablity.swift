//
//  UITableViewCell+Testablity.swift
//  MixboxInAppServices
//
...
extension UITableView {
    ...
    public func mb_startTableViewUpdates() -> MixboxTableViewUpdatesActivity {
        return FakeCellManagerProvider.fakeCellManager.startTableViewUpdates(forTableView: self)
    }
}
