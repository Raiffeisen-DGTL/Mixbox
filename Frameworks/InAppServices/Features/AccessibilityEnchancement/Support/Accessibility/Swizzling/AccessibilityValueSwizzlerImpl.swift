...
// TODO: Split, add factories and stuff.
// TODO: Remove singletons.
// TODO: Use AssertingSwizzler.
public final class AccessibilityValueSwizzlerImpl: AccessibilityValueSwizzler {
    private let onceToken = ThreadUnsafeOnceToken()
    
    // NOTE: Instance will live forever after calling this function:
    public func swizzle() {
    ...
    private func swizzleForIos9or10() {
    ...
    private func swizzleAllAccessibilityValueMethods() {
    ...
    private func replaceAccessibilityValueMethod(method: Method) {
        ...
        let newImplementationBlock: @convention(block) (NSObject?) -> NSString? = { this in
            self.enhancedAccessibilityValue(this: this) {
    ...
    private func allMethodsWithUniqueImplementation(
        selector: Selector,
        baseClass: AnyClass)
        -> [Method]
    {
    ...
    private func enhancedAccessibilityValue(
        this: NSObject?,
    ...
    private func unwrapAccessibilityValue(_ originalImplementation: () -> (NSString?)) -> NSString {
